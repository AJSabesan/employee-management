...
const LoginPage: React.FC<Props> = ({ onLogin, goToRegister }) => {
    ...
    return (
        ...
        >
            <div className="pointer-events-none absolute inset-0">
                ...
                <div className="animate-float absolute bottom-0 left-1/3 h-80 w-80 rounded-full bg-white/10 blur-2xl" style={{ animationDelay: '4s' }} />
            </div>
            ...
            >
                ...
                <div className="mt-8 space-y-4">
                    ...
                    >
                        {loading ? <span className="h-5 w-5 rounded-full border-2 border-white/40 border-t-white animate-spin" /> : 'Sign In'}
                    </button>

                    <p className="pt-2 text-center text-sm text-gray-500">
                        Don't have an account?{' '}
                        <button type="button" onClick={goToRegister} className="font-semibold text-[#764ba2] hover:underline">
                            Register
                        </button>
                    </p>
                </div>
